...
CardSpace = (function(superClass) {
  extend(CardSpace, superClass);

  function CardSpace() {
    return CardSpace.__super__.constructor.apply(this, arguments);
  }
  ...
  CardSpace.init = function() {
    return this.cards = [];
  };

  CardSpace.getCardNum = function(index) {
    return this.cards[index];
  };

  CardSpace.getCardClass = function(index) {
    return Card.getClass(this.getCardNum(index));
  };

  CardSpace.cardLeftClickAction = function(elem) {};

  CardSpace.cardRightClickAction = function(elem) {};

  CardSpace.cardDoubleClickAction = function(elem) {};

  CardSpace.additionalCardAction = function(elem, index) {};

  CardSpace.redraw = function() {
  ...
  CardSpace.createElement = function(index) {
    ...
    e = $('<div>').attr('data-index', index).addClass('card').addClass(this.DIV_ID);
    ...
    e.append(pointSpan);
    this.additionalCardAction(e, index);
    return e;
  };
...
DeviceChecker = (function() {
  ...
  DeviceChecker.srcCss = function() {
    if (DeviceChecker.isTouchDevice) {
      return './css/index-sm.css';
    } else {
      return './css/index-pc.css';
    }
  };
  ...
  DeviceChecker.setDoubleClickAction = function($elem, spaceAction) {
    if (this.isTouchDevice) {
      return $elem.on('touchend', function(ev) {
        return ev.preventDefault();
      }).hammer().on('doubletap', function() {
        return spaceAction($elem);
      });
    } else {
      return $elem.on('dblclick', function() {
        return spaceAction($elem);
      });
    }
  };

  DeviceChecker.setLeftClickAction = function($elem, spaceAction) {
    if (this.isTouchDevice) {
      return $elem.hammer().on('panleft', function() {
        return spaceAction($elem);
      });
    } else {
  ...
  DeviceChecker.setRightClickAction = function($elem, spaceAction) {
    if (this.isTouchDevice) {
      return $elem.hammer().on('panright', function() {
        return spaceAction($elem);
      });
    } else {
      return $elem.on('contextmenu', function() {
        return spaceAction($elem);
      });
    }
  };
...
HandSpace = (function(superClass) {
  ...
  HandSpace.cardLeftClickAction = function(elem) {
    var index;
    index = $(elem).attr('data-index');
    return Game.handClickLeft(Number(index));
  };

  HandSpace.cardRightClickAction = function(elem) {
    var index;
    index = $(elem).attr('data-index');
    return Game.handClickRight(Number(index));
  };

  HandSpace.cardDoubleClickAction = function(elem) {
    var index;
    index = $(elem).attr('data-index');
...
PrivateSpace = (function(superClass) {
  ...
  PrivateSpace.cardDoubleClickAction = function(elem) {
    var index;
    if (Game.isClickable) {
  ...
  PrivateSpace.additionalCardAction = function(elem, index) {
    if (this.status[index] === this.STATUS_WORKED) {
      elem.addClass('card_used');
      return elem.append($('<img>').attr('src', this.IMG_WORKER).addClass('card_worker'));
    }
  };
...
PublicSpace = (function(superClass) {
  ...
  PublicSpace.cardDoubleClickAction = function(elem) {
    var index;
    index = $(elem).attr('data-index');
    return Game.work('public', index);
  };

  PublicSpace.additionalCardAction = function(elem, index) {
    switch (this.status[index]) {
      ...
      case this.STATUS_DISABLED:
        elem.addClass('card_used');
        return elem.append($('<img>').attr('src', this.IMG_DISABLER).addClass('card_worker'));
    }
  };
